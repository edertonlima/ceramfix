	...
	<div class="container">
		...
		<div class="row">
			<form action="<?php echo get_template_directory_uri(); ?>/mail_trabalhe.php" class="contato-home" enctype="multipart/form-data" method="POST">
				...
				<fieldset class="col-6">
					<span><input type="text" name="tel_princ" id="tel_princ" placeholder="<?php echo $idioma_fale[4]; ?>:"></span>
				</fieldset>
				<fieldset class="col-6" style="clear: none;">
					<span><input type="text" name="tel_sec" id="tel_sec" placeholder="<?php echo $idioma_fale[5]; ?>:"></span>
				</fieldset>
				...
				<fieldset class="col-6">
					<span><input type="file" name="arquivo" id="arquivo" placeholder="<?php echo $idioma_fale[9]; ?>:" style="margin-top: 11px;"></span>
