		...
		if ( 'html5' == $format ) {
			$form = '<form role="search" method="get" class="search-form" action="' . esc_url( home_url( '/' ) ) . '">
				<label>
					...
					<fieldset>
						<span>
							<input type="search" class="text-search search-field" placeholder="' . esc_attr_x( 'Search &hellip;', 'placeholder' ) . '" value="' . get_search_query() . '" name="s" placeholder="O que você deseja buscar?" />
						</span>
					</fieldset>
				</label>
				<fieldset>
			...
			$form = '<form role="search" method="get" id="searchform" class="searchform" action="' . esc_url( home_url( '/' ) ) . '">
				<div>
					...
					<fieldset>
						<span>
							<input class="text-search" type="text" value="' . get_search_query() . '" name="s" id="s" placeholder="O que você deseja buscar?" />
						</span>
					</fieldset>
					<fieldset>
